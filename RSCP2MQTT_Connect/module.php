...
require_once __DIR__ . '/../libs/RSCPModule.php';
	...
	{	
		...
		public function GetConfigurationForm()
		{
			...
			$jsonform["elements"][0]['items'][0]["values"] = $Variables;
...
*/
			...
			['HEADER'	,950	,0		,'BATTERY MODULS'		 				, ''												, ''										, ''				, 	''						,  1	, false, false],
			['DCB '		,10001	,950	,'dcb_module_#_soc'						, 'TAG_BAT_DCB_SOC' 								, 'e3dc/battery/dcb/[1-9]/soc'				, VARIABLETYPE_FLOAT, 	'RSCP.Percent'  		,  1	, false, false],
			['DCB '		,10002	,950	,'dcb_module_#_soh'						, 'TAG_BAT_DCB_SOH' 								, 'e3dc/battery/dcb/[1-9]/soh'				, VARIABLETYPE_FLOAT, 	'RSCP.Percent'  		,  1	, false, false],
			['DCB '		,10003	,950	,'dcb_module_#_cycles'					, 'TAG_BAT_DCB_CYCLE_COUNT'							, 'e3dc/battery/dcb/[1-9]/cycles'			, VARIABLETYPE_INTEGER,	''				  		,  1	, false, false],

			['DCB '		,10050	,950	,'dcb_module_#_manufacture_name'		, 'TAG_BAT_DCB_MANUFACTURE_NAME'					, 'e3dc/battery/dcb/[1-9]/manufacture_name'	, VARIABLETYPE_STRING,	''				  		,  1	, false, false],
			['DCB '		,10050	,950	,'dcb_module_#_serialno'				, 'TAG_BAT_DCB_SERIALNO'							, 'e3dc/battery/dcb/[1-9]/serialno'			, VARIABLETYPE_STRING,	''				  		,  1	, false, false],
