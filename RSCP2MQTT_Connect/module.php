...
require_once __DIR__ . '/../libs/RSCPModule.php';
	...
	{	
		...
		// 	NSPACE  	POS	 PARENT		IDENT							RSCP TAG 									MQTT Topic								Variablen Typ			Var Profil	  			Faktor  ACTION  KEEP
			...
			['DB'		,830	,800	,'year_solar_energy'			, 'TAG_DB_HISTORY_DATA_YEAR'				, 'e3dc/year/solar/energy'				, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,831	,800	,'year_battery_energy_charge'	, 'TAG_DB_HISTORY_DATA_YEAR'				, 'e3dc/year/battery/energy/charge'		, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,832	,800	,'year_battery_energy_discharge', 'TAG_DB_HISTORY_DATA_YEAR'				, 'e3dc/year/battery/energy/discharge'	, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,833	,800	,'year_home_energy'				, 'TAG_DB_HISTORY_DATA_YEAR'				, 'e3dc/year/home/energy'				, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,834	,800	,'year_grid_energy_in'			, 'TAG_DB_HISTORY_DATA_YEAR'				, 'e3dc/year/grid/energy/in'			, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,835	,800	,'year_grid_energy_out'			, 'TAG_DB_HISTORY_DATA_YEAR'				, 'e3dc/year/grid/energy/out'			, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
