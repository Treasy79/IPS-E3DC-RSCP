...
require_once __DIR__ . '/../libs/RSCPModule.php';
	...
	{	
		...
		// 	NSPACE  	POS	 PARENT		IDENT									RSCP TAG 									MQTT Topic									Variablen Typ			Var Profil	  			Faktor  ACTION  KEEP
			...
			['DB'		,801	,800	,'yesterday_solar_energy'				, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/yesterday/solar/energy'				, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,803	,800	,'yesterday_battery_energy_charge'		, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/yesterday/battery/energy/charge'	, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,804	,800	,'yesterday_battery_energy_discharge'	, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/yesterday/battery/energy/discharge'	, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,805	,800	,'yesterday_home_energy'				, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/yesterday/home/energy'				, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,806	,800	,'yesterday_grid_energy_in'				, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/yesterday/grid/energy/in'			, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,807	,800	,'yesterday_grid_energy_out'			, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/yesterday/grid/energy/out'			, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,808	,800	,'yesterday_autarky'					, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/yesterday/consumed'					, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
			['DB'		,809	,800	,'yesterday_consumed_production'		, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/yesterday/autarky'					, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
			['DB'		,811	,800	,'today_solar_energy'					, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/solar/energy'						, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,813	,800	,'today_battery_energy_charge'			, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/battery/energy/charge'				, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,814	,800	,'today_battery_energy_discharge'		, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/battery/energy/discharge'			, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,815	,800	,'today_home_energy'					, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/home/energy'						, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,816	,800	,'today_grid_energy_in'					, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/grid/energy/in'						, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,817	,800	,'today_grid_energy_out'				, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/grid/energy/out'					, VARIABLETYPE_FLOAT, 	'~Electricity' 			,  1	, false, true],
			['DB'		,818	,800	,'today_autarky'						, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/consumed'							, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
			['DB'		,819	,800	,'today_consumed_production'			, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/autarky'							, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
			...
			['DB'		,828	,800	,'week_autarky'							, 'TAG_DB_HISTORY_DATA_WEEK'				, 'e3dc/week/consumed'						, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
			['DB'		,829	,800	,'week_consumed_production'				, 'TAG_DB_HISTORY_DATA_WEEK'				, 'e3dc/week/autarky'						, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
			...
			['DB'		,838	,800	,'month_autarky'						, 'TAG_DB_HISTORY_DATA_MONTH'				, 'e3dc/month/consumed'						, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
			['DB'		,839	,800	,'month_consumed_production'			, 'TAG_DB_HISTORY_DATA_MONTH'				, 'e3dc/month/autarky'						, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
			...
			['DB'		,848	,800	,'year_autarky'							, 'TAG_DB_HISTORY_DATA_YEAR'				, 'e3dc/year/consumed'						, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
			['DB'		,849	,800	,'year_consumed_production'				, 'TAG_DB_HISTORY_DATA_YEAR'				, 'e3dc/year/autarky'						, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
