...
require_once __DIR__ . '/../libs/RSCPModule.php';
	...
	{	
		...
		// 	NSPACE  	POS	 PARENT		IDENT									RSCP TAG 									MQTT Topic									Variablen Typ			Var Profil	  			Faktor  ACTION  KEEP
			...
			['DB'		,808	,800	,'yesterday_autarky'					, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/yesterday/autarky'					, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
			['DB'		,809	,800	,'yesterday_consumed_production'		, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/yesterday/consumed'					, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
			...
			['DB'		,818	,800	,'today_autarky'						, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/autarky'							, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
			['DB'		,819	,800	,'today_consumed_production'			, 'TAG_DB_HISTORY_DATA_DAY'					, 'e3dc/consumed'							, VARIABLETYPE_FLOAT, 	'RSCP.Percent' 			,  1	, false, true],
